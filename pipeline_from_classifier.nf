...
process import_json_to_mongo {
    ...
    import-json-to-mongo -i $input_import_json_to_mongo -c "mongodb://OHakimi:deb2020..@mdb-login.bsc.es:27017/?authSource=DEBBIE&authMechanism=SCRAM-SHA-1" -d DEBBIE -collection pdo_11-06-2020
