...
log.info """
There is no input directory, pubmed retrieval is used to download the abstracts.
Base directory to use: ${params.baseDir}, This directory is used as a work directory of the pipeline, each component output will appear in this directory.
...
process import_json_to_mongo {
    ...
    import-json-to-mongo -i $input_import_json_to_mongo -c xxxxxxxxxx -d xxxxxx -collection xxxxxx
